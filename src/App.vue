...
<template>
  <div>
    <div 
      class="w-[calc(100%-140px)] sm:w-[calc(100%-240px)] h-[60px] fixed right-0 z-20 bg-[#101010] bg-opacity-80 flex items-center justify-between"
    >
      ...
      >
        <div class="flex items-center">
          <img 
            class="rounded-full" 
            width="27"
            src="https://yt3.ggpht.com/LrLedNcCbXvUz4YugdOCgBXSDNxkrAra5AC-0q5K7A1Iva-jRq_Q0JcCm4cxkn9hkAEZFZ6AHyo=s88-c-k-c0x00ffffff-no-rj"
          >
          <div class="text-white text-[14px] ml-1.5 font-semibold">SieghartSaladdin</div>
    ...
    <div class="h-[100%] p-6 w-[240px] fixed z-50 bg-black" id="SideNav">
      <router-link to="/">
        <img src="/images/icons/spotify-logo.png" width="125" alt="iconSpotify">
      </router-link>
      <div class="my-8"></div>
      <ul>
        <router-link to="/">
