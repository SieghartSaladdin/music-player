    ...
    >
        <div class="flex items-center w-1/4">
            <div class="flex items-center ml-4">
                ...
                <div class="ml-4">
                    <div class="text-[14x] text-white hover:underline cursor-pointer">
                        {{ currentTrack.name }}
                    </div>
                    <div class="text-[11x] text-gray-400 hover:underline hover:text-white cursor-pointer">
                        {{ currentTrack.name }}
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-[35%] mx-auto w-2/4 mb-3">
            ...
            <div class="flex items-center h-[25px]">
                ...
                <div v-if="isTrackTimeTotal" class="text-white text-[12px] pr-2 pt-[11px] ml-3">
                    {{ isTrackTimeTotal }}
                </div>
            </div>
        </div>
